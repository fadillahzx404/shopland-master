        ...
        <section class="product-edit card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                <div class="grid title gap-2">
                    <p class="text-lg font-medium">Add New Banner</p>
                    <hr class="mb-3 border-gray-300" />
                </div>
                <form action="{{ route('banners.store') }}" method="POST" class="grid gap-3" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-control">
                        ...
                        <img id="blah" class="rounded-xl" src="" />
                    </div>
