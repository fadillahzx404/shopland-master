...
@section('page-content')
    <div class="container px-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <p class="text-3xl font-semibold mt-8 mb-6">All Categories Product</p>
            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Category Product</p>
                        <p class="text-sm font-light text-gray-400">All Category on here, you can add new category, edit or
                            delete.
                        </p>
                    </div>
