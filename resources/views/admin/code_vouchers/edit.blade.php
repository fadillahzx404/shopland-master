    ...
    <div class="container px-12 lg:mt-10 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <section class="product-edit card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                ...
                <form action="{{ route('code-vouchers.update', $voucher->id) }}" method="POST" class="grid gap-3"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="discount" value="{{ $voucher->discount }}"
                                class="input input-bordered input-accent w-full focus:outline-offset-0 focus:border-accent" />
                        </div>
                    </div>
                    <div class="form-control">
                        ...
                        <textarea class="textarea textarea-accent focus:outline-offset-0 focus:border-accent" name="desc">{{ $voucher->desc }}</textarea>
                    </div>
